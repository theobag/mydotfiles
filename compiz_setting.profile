...
s0_next_no_popup_key = <Super>l
s0_prev_no_popup_key = <Super>h
...
s0_next_key = Disabled
s0_prev_key = Disabled
s0_next_all_key = <Super>k
s0_prev_all_key = <Super>j
s0_brightness = 95
s0_opacity = 100
...
s0_zoom_in_key = <Super>Up
s0_zoom_out_button = <Super>Button5
s0_zoom_out_key = <Super>Down
...
[extrawm]
s0_toggle_fullscreen_key = <Super>minus
...
[core]
s0_active_plugins = core;composite;opengl;decor;regex;matecompat;workspacenames;copytex;commands;resize;extrawm;wall;compiztoolbox;grid;imgpng;mousepoll;move;vpswitch;snap;place;thumbnail;expo;ezoom;staticswitcher;switcher;
s0_autoraise = false
s0_autoraise_delay = 500
s0_focus_prevention_level = 0
s0_close_window_key = <Super>Return
s0_minimize_window_key = <Super>BackSpace
s0_maximize_window_key = Disabled
s0_unmaximize_or_minimize_window_key = Disabled
s0_show_desktop_key = <Super>d
s0_toggle_window_maximized_key = <Super>equal
s0_toggle_window_maximized_horizontally_key = <Super>bracketright
s0_toggle_window_maximized_vertically_key = <Super>bracketleft
s0_toggle_window_shaded_key = <Super>backslash
s0_hsize = 4
